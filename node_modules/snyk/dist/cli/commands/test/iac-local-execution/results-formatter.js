...
exports.formatScanResults = void 0;
...
function formatScanResults(scanResults, options) {
    ...
    const formattedResults = scannedResultsGroupedByDocId.map((iacScanResult) => formatScanResult(iacScanResult, options.severityThreshold));
